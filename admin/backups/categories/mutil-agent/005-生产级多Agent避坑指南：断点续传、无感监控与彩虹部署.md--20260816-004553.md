...
[https://v.douyin.com/u4QwB83o4og/](https://v.douyin.com/u4QwB83o4og/)
...
把记忆、计划、执行步骤、中间结果全部存盘，故障后从断点继续执行，不从头重来。
...
直接看对话内容侵犯隐私，因此采用只看骨架（决策模式、交互结构、报错状态）、不看血肉（具体对话，用户隐私数据）的高层监控：

1）不看用户说什么、不看具体内容，只监控行为结构：
...
<img src="images/1786812092378-osti49.jpg" alt="" width="400">

传统蓝绿部署不适合Agent，因为任务可能跑数小时，新版本不能直接覆盖旧版本。
...
<img src="images/1786812092559-49fega.jpg" alt="" width="400">

当前问题——同步阻塞：指挥官派活给多个Agent后，必须等最慢的那个完成才能继续，算力闲置、吞吐量被锁死。
