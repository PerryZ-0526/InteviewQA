...
[[001-Hermes的理解与亮点#面试直接答#产品内置的学习闭环有四个组件]]
...
>
> [[004-Hermes-的程序化工具调用#dsh 把 Code Mode 做成 ToolRuntime 的“一等呈现模式”]]
>
> [[004-Hermes-的程序化工具调用#与dsh Code Mode的差异]]
