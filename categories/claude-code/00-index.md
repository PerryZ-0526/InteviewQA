...
- [✅Claude Code 子智能体类型与 Vibe Coding 场景](001-Claude Code子智能体类型与vibe-coding场景.md) - 命名型子智能体、对话分叉、worktree 与任务选择边界
- [Claude Code 与 Codex 的 Agent 架构区别](002-Claude Code与Codex架构区别.md) - 基于当前公开能力比较入口、委派、隔离和权限模型
